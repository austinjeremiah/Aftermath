...
const metadata = {
  name: 'Multi-Chain Activity Monitoring',
  description: 'Multi-Chain Activity Monitoring App',
  url: typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000', // Replace YOUR_APP_URL
  icons: ['https://avatars.githubusercontent.com/u/179229932'], // Replace YOUR_ICON_URL
}
...
if (!projectId) {
  ...
  createAppKit({
    ...
    networks: networks,
    defaultNetwork: sepolia, // Use Sepolia testnet as default
    metadata,
